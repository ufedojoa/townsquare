		...
		<Block titleClassName="text-xl" title="Space Threshold">
			...
			>
				<div className="flex justify-between">
					...
					<div className="flex items-center justify-end border border-skin-alt rounded-lg">
						<ChoiceButton
							disabled={loading || !threshold}
							onClick={() => threshold && setThreshold(threshold - 1n)}
							type="button"
						>
							-
						</ChoiceButton>
						<input
							...
							onChange={(e) => setThreshold(BigInt(e.target.value))}
						...
						<ChoiceButton
							disabled={loading}
							onClick={() => setThreshold(threshold + 1n)}
							type="button"
						>
							+
						</ChoiceButton>
